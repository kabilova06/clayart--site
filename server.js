...
try {
    ...
    // Если таблицы нет, создаём её с нужной структурой
    ...
    console.log('Ошибка проверки таблицы:', e.message);
...
try {
    ...
    if (count.count === 0) {
        ...
        console.log(`✅ В базе уже есть ${count.count} товаров. Ничего не перезаписываем.`);
    }
} catch(e) {
    console.log('Ошибка при добавлении товаров:', e.message);
}
